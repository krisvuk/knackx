...
class English_Page(MainHandler):
    def get(self):
        self.render('english.html')

class Math_Page(MainHandler):
    def get(self):
        self.render('math.html')

class Biology_Page(MainHandler):
    def get(self):
        self.render('biology.html')

class Chemistry_Page(MainHandler):
    def get(self):
        self.render('chemistry.html')

class Physics_Page(MainHandler):
    def get(self):
        self.render('physics.html')

class Web_Page(MainHandler):
    def get(self):
        self.render('web.html')

class Coding_Page(MainHandler):
    def get(self):
        self.render('coding.html')

class Art_Page(MainHandler):
    def get(self):
        self.render('art.html')

class History_Page(MainHandler):
    def get(self):
        self.render('history.html')

class Geography_Page(MainHandler):
    def get(self):
        self.render('geography.html')

class Languages_Page(MainHandler):
    def get(self):
        self.render('languages.html')

class Music_Page(MainHandler):
    def get(self):
...
class Profile(MainHandler):
    def get(self, user_id):
        ...
        if username == user_id:
            self.render('profile.html', username = self.user.name, day = self.user.day, month = self.user.month, year = self.user.year, country = self.user.country)
